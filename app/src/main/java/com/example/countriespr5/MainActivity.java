package com.example.countriespr5;
...
public class MainActivity extends ListActivity {
    ...
    String[] countries = { "Аргентина", "Бразилия", "Чили", "Колумбия", "Уругвай", "Кузнецов Данил"};
        ...
        AdapterView.OnItemClickListener itemListener = new AdapterView.OnItemClickListener() {
                ...
                switch (position){
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        Intent intent5 = new Intent(MainActivity.this, Kyznetsov.class);
